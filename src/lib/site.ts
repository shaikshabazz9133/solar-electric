...
export const siteConfig = {
  name: "Eagle Electric & Solar",
  shortName: "Eagle",
  legalName: "Eagle Electric & Solar, LLC",
  tagline: "Licensed electricians. Certified solar installers.",
  description:
    "Eagle Electric & Solar designs, installs and services electrical systems, solar arrays, battery storage and EV charging for homes and businesses. Licensed, bonded, insured — and backed by a 25-year workmanship warranty.",
  url: "https://www.northstarelectric.com",
  locale: "en-US",
  phone: "+61 450 627 007",
  phoneHref: "tel:+61450627007",
